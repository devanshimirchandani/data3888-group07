  ...
  div(class = "topbar-container",
      div(
        ...
        tags$a(
          ...
          title = "Click to view code on Preva", 
          img(
            src = "Preva.png",
            class = "logo-title",
            `data-step` = 1,
            `data-intro` = "Click the Preva logo to visit our GitHub for more details, source code, and team introduction."
          )
        )
      )
      ,
...
server <- function(input, output, session) {
  ...
  observeEvent(input$module1_tabs, {
    if (input$module1_tabs == "lo2_gene") {
      updateTabsetPanel(session, "module1_lo2_subtabs", selected = "inner_gene")
    } else if (input$module1_tabs == "check_quiz") {
      updateTabsetPanel(session, "module1_quiz_subtabs", selected = "Quiz")
    }
  })
  ...
  observeEvent(input$module2_tabs, {
    if (input$module2_tabs == "LO3: Using GEO DB/GSE Data") {
      ...
      updateTabsetPanel(session, "module2_tabs", selected = "Check Your Understanding") 
  ...
  output$main_ui <- renderUI({
    ...
    switch(page(),
           "About" = {
             ...
             h2("Overview of the Preva Workflow"),
             tags$img(src = "Workflow.png", width = "80%"))
           ...
           "Module 1" = {
             div(class = "nav-tabs lo-tab",
                 tabsetPanel(id = "module1_tabs", type = "tabs",
                             ...
                             tabPanel("Check Your Understanding", value = "check_quiz",
                                      div(class = "nav-tabs sub-tab",
                                            ...
                                            tabPanel("Visualization",
                                              ...
                                              div(class = "selector-row",
                                                  fluidRow(
                                                    ...
                                                    column(6,
                                                           selectInput(
                                                             "type_choice_vis", "Type:",
                                                             choices  = c(
                                                               "Mapping",
                                                               "Standardizing",
                                                               "Sample_Counts",
                                                               "Grade_Distribution",
                                                               "countes_removing_missing",
                                                               "Gene_Expression",
                                                               "batch_correction",
                                                               "Class_Smote",
                                                               "PCA_somte"            
                                              ...
                                              uiOutput("vis_explanation_ui"),
                                              uiOutput("vis_image_ui")
                                                    ...
                                                    tabsetPanel(id = "module3_lo5_subtabs", type = "tabs",
                                                                tabPanel("Model Building",
                                                                         div(class = "browse-instruction",
                                                                             ...
                                                                             p("This section introduces three machine learning models: Support Vector Machine (SVM), K-Nearest Neighbours (KNN), and Random Forest (RF)."),
                                                                             p("You’ll learn what each model does and how they approach the task of classifying breast cancer grades using gene expression data."),
                                                                             p("We’ve already trained these models on selected gene subsets, and you’ll get to use them to make predictions.")
                                                                         ),
                                                                         h1("Overview"),
                                                                ...
                                                                tabPanel("Gene Analysis",
                                                                         div(class = "browse-instruction",
                                                                             h3("Explore Gene Expression Across Grades"),
                                                                             p("This section helps you understand how individual genes behave across different cancer grades."),
                                                                             p("By selecting specific genes, you can visualise their expression patterns using boxplots."),
                                                                             p("This helps reveal which genes are up- or down-regulated as cancer progresses, offering biological insights."),
                                                                             p("Use the slider to adjust how many genes to view, or select specific ones using checkboxes.")
                                                                         ),
                                                                ...
                                                                tabPanel("Performance", value = "Performance",
                                                                         div(class = "browse-instruction",
                                                                             h3("Evaluating Model Predictions"),
                                                                             p("This page helps you assess how well your selected model is performing."),
                                                                             p("You can visualise predicted vs true grades using bar charts or confusion matrices."),
                                                                             p("The heatmap shows how gene expression differs across patient samples."),
                                                                             p("This section is especially useful when you want to understand whether the model is making systematic errors."),
                                                                             p("Toggle between 'selected patients' or 'use full dataset' to focus your evaluation.")
                                                                         ),
                                                    ...
                                                    tags$div(class = "sub-tab",
                                                             tabsetPanel(id = "module4_lo6_subtabs", type = "tabs",
                                                                         ...
                                                                         tabPanel("F score", 
                                                                                  div(class = "browse-instruction",
                                                                                      h3("What You’ll Learn"),
                                                                                      p("This section helps you understand how well the model balances precision and recall. 
                                                                                        F1 Score is especially useful when data is imbalanced."),
                                                                                      p("Here you can see per-grade performance of your selected model.")
                                                                                  ),
                                                                                  div(class = "metric-interpretation",
                                                                                      h3("F1 Score in Breast Cancer Context"),
                                                                                      p("The F1 score balances precision and recall, which is particularly important in breast cancer prediction. A high false negative rate (low recall) means potentially missing a cancer diagnosis—possibly delaying treatment and worsening patient outcomes. On the other hand, a high false positive rate (low precision) can cause unnecessary anxiety and lead to invasive follow-ups. Thus, a high F1 score indicates a strong balance between catching as many true cases as possible while minimizing misclassifications.")
                                                                                  ),
                                                                                  h1("F1 Score Summary"),
                                                                         ...
                                                                         tabPanel("Kappa",
                                                                                  h1("Cohen’s Kappa Evaluation"),
                                                                                  
                                                                                  div(class = "browse-instruction",
                                                                                      h3("What You'll Learn"),
                                                                                      p("Kappa measures agreement between the model’s predictions and the actual outcomes, accounting for agreement by chance. In breast cancer diagnostics, this is important because accuracy alone can be misleading when classes are imbalanced (e.g., far more healthy cases than cancer cases). A high kappa value indicates that the model is reliably identifying cancer beyond what would be expected by random guessing—providing stronger confidence in its clinical applicability.")
                                                                                  ),
                                                                                  div(class = "metric-interpretation",
                                                                                      h3("Kappa in Breast Cancer Prediction"),
                                                                                      p("Cohen’s Kappa measures the agreement between predicted and actual grades, while accounting for agreement that could occur by chance."),
                                                                                      p("This is crucial in breast cancer diagnostics, where class imbalance is common (e.g., far more healthy cases than cancer cases)."),
                                                                                      p("A high Kappa value means the model is making reliable predictions that go beyond random guessing, offering more confidence in clinical decision-making.")
                                                                                  ),
                                                                                  DT::dataTableOutput("metric_table")
                                                                                  
                                                                                  
                                                                         ),
                                                                         tabPanel("Balanced Accuracy", 
                                                                                  h1("Balanced Accuracy"),
                                                                                  
                                                                                  div(class = "browse-instruction",
                                                                                      h3("Understanding Balanced Accuracy"),
                                                                                      p("Balanced Accuracy is designed to address imbalanced classification problems—like those often found in medical datasets such as breast cancer grades."),
                                                                                      tags$ul(
                                                                                        tags$li("It calculates the average of recall (true positive rate) across all classes."),
                                                                                        tags$li("Unlike standard accuracy, it treats each class equally, regardless of how frequent or rare it is."),
                                                                                        tags$li("It’s particularly useful when some tumour grades (e.g., Grade 1 or 3) are underrepresented.")
                                                                                      ),
                                                                                      p("This metric helps ensure that minority classes are not overlooked by the model. The closer the score is to 1.0, the better the model performs across all classes.")
                                                                                  ),
                                                                                  div(class = "metric-interpretation",
                                                                         ...
                                                                         tabPanel("ROC / AUC", 
                                                                                  div(class = "browse-instruction",
                                                                                      h3("Why Use ROC / AUC?"),
                                                                                      p("ROC curves help you understand how good the model is at distinguishing between classes. 
                                                                                        AUC (Area Under the Curve) tells you how well the model separates each class from the others."),
                                                                                      p("AUC closer to 1 means excellent separation; 0.5 means random guessing.")
                                                                                  ),
                                                                         ...
                                                                         tabPanel("Confusion Matrix",
                                                                                  ...
                                                                                  div(class = "metric-interpretation",
                                                                                      h2("Specificity (True Negative Rate)"),
                                                                                      p("Specificity measures the ability to correctly identify healthy individuals as non-cancerous. In breast cancer screening, high specificity helps reduce false positives, which can lead to overdiagnosis, stress, and unnecessary biopsies. However, maximizing specificity should not come at the cost of missing true cancer cases—so it must be balanced carefully with sensitivity (recall).")
                                                                                  ),
                                                                         ...
                                                                         tabPanel("Cross Validation",
                                                                                  ...
                                                                                  h3("10-fold Cross Validation Workflow"),
                                                                                  tags$img(src = "CV.png", width = "70%"),
                                                                                  p(em("Note: This diagram illustrates a 10-fold cross-validation process. In this analysis, we used 5-fold cross-validation, which follows the same principle but divides the data into 5 parts instead of 10."))
                                                                                  
                                                                         ),
                                                                         tabPanel("Model Comparison",
                                                                                  div(class = "browse-instruction",
                                                                                      h3("Comparing Models"),
                                                                                      p("This section compares different models (SVM, KNN, RF) trained on various gene sets."),
                                                                                      p("Use it to explore which model consistently performs best, and how gene set size influences accuracy.")
                                                                                  ),
                                                                                  h1("Model Comparison"),
                                                                                  ...
                                                                                  p("You can choose the number of top genes (from the selector above) and the cross-validation scheme (5-fold) to explore how model performance changes."),
                                                    ...
                                                    tags$div(class = "sub-tab",
                                                             tabsetPanel(id = "module4_lo7_subtabs", type = "tabs",
                                                                         ...
                                                                         tabPanel(
                                                                           ...
                                                                           h1("Summary of Model Performance Across Datasets"),
                                                                           div(class = "browse-instruction",
                                                                               h3("How to Read the Heatmap"),
                                                                               p("This heatmap shows the prediction accuracy of the top-performing models (SVM, KNN, RF) for each dataset."),
                                                                               tags$ul(
                                                                                 tags$li("Each cell represents the accuracy score of a specific model on a dataset, using a top gene set."),
                                                                                 tags$li("Darker colors indicate higher accuracy."),
                                                                                 tags$li("Rows correspond to datasets (e.g., GSE15852, GSE17907, Combined)."),
                                                                                 tags$li("Columns correspond to top gene sets used (e.g., Top 30, Top 50, Top 80, Top 110).")
                                                                               ),
                                                                               p("Use this heatmap to quickly identify which model performed best for each dataset and gene set.")
                                                                           ),
                                                                           
                                                                           br(),
                                                                           imageOutput("heatmap_img", width  = "600px", height = "420px")
                                                                         ),
                                                                         tabPanel(
                                                                           "Limitations", 
                                                                           h1("Limitations"),
  ...
  output$vis_image_ui <- renderUI({
    ds   <- input$dataset_choice_vis
    type <- input$type_choice_vis
    
    img_file <- if (ds == "Combined") {
      paste0(type, "_combined.png")
    } else {
      paste0(ds, "_", type, ".png")
    }
    
    tags$img(
      src    = img_file,
      alt    = paste(ds, type, "Visualization"),
      width  = "600px",
      height = "420px"
    )
  })
  output$vis_explanation_ui <- renderUI({
    type <- input$type_choice_vis
    
    explanation <- switch(type,
                          "Mapping" = "The first step of data processing after loading our datasets was mapping the original grade names to their standardized counterparts. This bar plot shows how labels such as 'grade: I', 'grade: II', or numeric values like 1, 2, 3 from different datasets were observed. This mapping allows us to move toward unified labels.",
                          
                          "Standardizing" = "After the mapping process, we standardized the grade labels to unified terms: Grade1, Grade2, Grade3, and Normal. This Sankey diagram visualizes how inconsistent labels across datasets were merged into standard categories, enabling model training across batches.",
                          
                          "Sample_Counts" = "Once datasets were standardized, they could be merged. This plot visualizes the grade composition of each dataset. It helps us understand sample distribution across grades and batches, especially identifying underrepresented groups before model training.",
                          
                          "Grade_Distribution" = "This plot displays the overall grade distribution after merging the datasets. It clearly shows a strong class imbalance, especially with fewer samples labeled as Grade1, which could negatively affect model training if not addressed.",
                          
                          "countes_removing_missing" = "After merging datasets, many missing (NA) values may still exist, both in the 'Grade' column and in the gene expression matrix. This plot shows the number of genes before and after removing those with missing values—this is an essential cleanup step before model input.",
                          
                          "Gene_Expression" = "Next, lowly expressed genes are removed to reduce noise, improve statistical power, speed up analysis, and focus on biologically relevant genes. These density plots show gene median expression and variance before and after filtering. Genes with low median expression and low standard deviation were filtered out.",
                          
                          "batch_correction" = "After filtering, batch correction (ComBat) is used to remove technical differences (such as those due to lab origin or equipment). The left PCA plot shows samples clustering by batch before correction; the right plot shows better overlap post-correction, indicating successful batch effect removal.",
                          
                          "Class_Smote" = "Once data is cleaned and split into train/test (80/20), we apply resampling to balance class distributions. This bar plot shows the difference before and after applying SMOTE, a popular synthetic sampling technique. Grade1, originally underrepresented, is now rebalanced to avoid biased learning.",
                          
                          "PCA_somte" = "This PCA plot overlays synthetic SMOTE samples with original ones. The purpose is to visually verify that the new samples resemble the distribution of real ones and don’t introduce noise. It’s a quality check after resampling.",
                          
                          "No explanation available."
    )
    
    tags$div(
      style = "margin-top: 20px; background-color: #f9f4fb; padding: 15px; border-left: 4px solid #a86bbf;",
  ...
  output$heatmap_img <- renderImage({
    fname <- paste0("heatmap_", input$dataset_choice, ".png")
    full_path <- normalizePath(file.path("www", fname))
    
    list(
      src         = full_path,
      contentType = "image/png",
      alt         = paste("Heatmap for", input$dataset_choice),
      width       = 600,
      height      = 420
    )
  }, deleteFile = FALSE)
  ...
  output$metric_summary_table <- renderDT({
    req(input$dataset_choice)
    ...
    if (input$dataset_choice == "GSE17907") {
      df <- data.frame(
        Genes             = rep(c(30, 50, 80, 110), each = 3),
        Model             = rep(c("SVM","KNN","RF"), times = 4),
    ...
    if (input$dataset_choice == "Combined") {
      df <- data.frame(
        Genes             = rep(c(30, 50, 80, 110), each = 3),
        Model             = rep(c("SVM","KNN","RF"), times = 4),
  ...
  quiz_list_m1 <- list(
    list(
      ...
      options = c("A. To cure breast cancer", "B. To sell breast cancer medication to hospitals", "C. To detect and understand breast cancer", "D. To replace doctors in diagnosis"),
      answer = "C. To detect and understand breast cancer"
    ),
    list(
      text = "What technology does the Preva app use to make predictions?",
      options = c("A. Quantum computing", "B. Machine learning models", "C. Data Visualisation", "D. Blockchain"),
      answer = "B. Machine learning models"
    ),
    list(
      text = "What type of data is being used for the predictions?",
      options = c("A. Image data", "B. Gene expression data", "C. Specimen Data", "D. Stock market data"),
      answer = "B. Gene expression data"
    ),
    list(
      text = "What is the general cause of breast cancer?",
      options = c("A. Genetic mutations", "B. Bacterial growth in the breast.", "C. Lack of exercise and poor diet.", "D. Excessive hormone therapy use."),
      answer = "A. Genetic mutations",
      explanation = "Gene mutations are the primary cause of breast cancer, not external lifestyle factors alone."
    ),
    list(
      text = "What does gene expression refer to?",
      options = c("A. Translation of protein to DNA", "B. Transcription of RNA into protein", "C. Using information from DNA to make proteins", "D. DNA replication"),
      answer = "C. Using information from DNA to make proteins",
      explanation = "Gene expression is DNA → RNA → proteins regulating cellular function."
    ),
    list(
      text = "What is the main advantage of early breast cancer detection?",
      options = c("A. It reduces cost", "B. It lowers mutation risk", "C. It significantly improves survival rates", "D. It avoids the need for surgery"),
      answer = "C. It significantly improves survival rates",
      explanation = "Early detection via screening improves survival by catching cancer at a treatable stage."
    ),
    list(
      text = "What does the GSE15852 dataset include?",
      options = c("A. Whole-genome sequences", "B. Drug response scores", "C. Tumour samples from Grade I to III", "D. Patient survival times only"),
      answer = "C. Tumour samples from Grade I to III",
      explanation = "GSE15852 contains tumour gene expression across histological grades."
    )
  )
  ...
  quiz_list_m2 <- list(
    list(
      ...
      options = c("A. TrueGrade", "B. PredictedGrade", "C. Patient", "D. Grade 6 Chance"),
      answer = "D. Grade 6 Chance",
      explanation = "Check column names in the 'Dataset Overview' tab—Grade 6 Chance is not present."
    ),
    list(
      text = "How many counts of grade 1 cancer are there in the GSE15852 dataset?",
      options = c("A. 25", "B. 10", "C. 19", "D. 8"),
      answer = "D. 8",
      explanation = "Click 'About Datasets' and check the count column for Grade 1."
    ),
    list(
      text = "Which of the following is a type of histopathology?",
      options = c("A. Infiltrating ductal carcinoma", "B. Fibrous adenoma", "C. Basal squamous carcinoma", "D. Lobular duct syndrome"),
      answer = "A. Infiltrating ductal carcinoma",
      explanation = "Check the dataset overview under the histopathology column."
    ),
    list(
      text = "What grade of breast cancer does patient GSM398079 have?",
      options = c("A. Grade 1", "B. Grade 2", "C. Grade 3", "D. Normal"),
      answer = "C. Grade 3",
      explanation = "Search for GSM398079 in 'Dataset Overview' to find the grade."
    ),
    list(
      text = "What is the gene count in the GSE17907 dataset?",
      options = c("A. 22282", "B. 16760", "C. 24577", "D. 18000"),
      answer = "C. 24577",
      explanation = "Refer to the dataset properties, gene count column."
    ),
    list(
      text = "Why are low-expression genes filtered out?",
      options = c("A. They contain incorrect labels", "B. They cause memory overflow", "C. To reduce noise and improve signal clarity", "D. They are duplicates"),
      answer = "C. To reduce noise and improve signal clarity",
      explanation = "Low-expression genes add noise and are not useful for prediction."
    ),
    list(
      text = "What does SMOTE help with in the Preva pipeline?",
      options = c("A. Addressing class imbalance in tumour grades", "B. Removing noisy genes", "C. Increasing RNA sequencing speed", "D. Converting grades into numeric values"),
      answer = "A. Addressing class imbalance in tumour grades",
      explanation = "SMOTE synthetically balances underrepresented tumour grades."
    ),
    list(
      text = "What is the main purpose of PCA in this app?",
      options = c("A. To predict tumour grade", "B. To visualise sample clustering by grade or dataset origin", "C. To cluster samples by gene mutation", "D. To balance class distribution"),
      answer = "B. To visualise sample clustering by grade or dataset origin",
      explanation = "PCA is used after pre-processing to check how samples group by grade or origin."
    )
  )
  ...
  quiz_list_m3 <- list(
    list(
      text = "If a patient has a True Grade of 0 but a prediction of Grade 1, what does this indicate?",
      options = c("A. The model is likely underfitting", "B. The model misclassified the sample", "C. The true label is wrong", "D. The model ignored Grade 0"),
      answer = "B. The model misclassified the sample",
      explanation = "When predicted grade differs from the true grade, it reflects misclassification."
    ),
    list(
      text = "What is the main idea behind how a support vector machine (SVM) model works?",
      options = c("A. It averages predictions from many models", "B. It counts how often each class appears in the data", "C. It finds an optimal hyperplane to separate categories", "D. It clusters similar points together"),
      answer = "C. It finds an optimal hyperplane to separate categories",
      explanation = "SVM separates classes by finding a hyperplane, often in higher-dimensional space."
    ),
    list(
      text = "What is the grade 1 chance of breast cancer for patient GSM398103?",
      options = c("A. 16.4%", "B. 55.9%", "C. 20.6%", "D. 8.3%"),
      answer = "A. 16.4%",
      explanation = "Go to the prediction tab and find this patient to see the Grade 1 chance column."
    ),
    list(
      text = "Which breast cancer stage has the highest median expression level for Gene 201650_at?",
      options = c("A. Normal", "B. 1", "C. 2", "D. 3"),
      answer = "C. 2",
      explanation = "Click the 'Gene Analysis' tab and check the boxplot for gene 201650_at."
    ),
    list(
      text = "Which model had the most correct predictions using the GSE15852 dataset?",
      options = c("A. Models have an equal number of correct predictions.", "B. SVM", "C. RF", "D. KNN"),
      answer = "B. SVM",
      explanation = "SVM had 10 correct predictions vs. 9 for others, based on the performance heatmap."
    ),
    list(
      text = "Why might gene expression differ across tumour grades?",
      options = c("A. Different tumour grades involve different molecular changes", "B. The data is randomised", "C. Patients were treated with different drugs", "D. Expression is manually adjusted per grade"),
      answer = "A. Different tumour grades involve different molecular changes",
      explanation = "Higher grades often show altered gene regulation due to cancer progression."
    )
  )
  ...
  quiz_list_m4 <- list(
    list(
      ...
      answer = "C. RF",
      explanation = "The RF model's boxplot has the highest middle line (median)."
    ),
    list(
      text = "Does changing from top110 to top80 improve RF median accuracy?",
      options = c("A. Improve", "B. Worsen"),
      answer = "B. Worsen",
      explanation = "Top110 shows accuracy >0.65, while top80 drops it below 0.65."
    ),
    list(
      text = "In the GSE15852 dataset, using the SVM model, and selecting ‘ROC / AUC’, which grade is falsely predicted the most?",
      options = c("A. Grade 0", "B. Grade 1", "C. Grade 2", "D. Grade 3"),
      answer = "B. Grade 1",
      explanation = "Grade 1 has the lowest AUC (0.632), indicating the highest false prediction rate."
    ),
    list(
      text = "In the model comparison boxplot, which model had the highest mean accuracy?",
      options = c("A. KNN", "B. RF", "C. SVM", "D. They are all equal"),
      answer = "B. RF",
      explanation = "RF had a mean accuracy of 0.857, slightly outperforming the others."
    ),
    list(
      text = "Which model had the best Kappa metric for the combined data set using the 110 top genes?",
      options = c("A. SVM", "B. KNN", "C. RF", "D. None"),
      answer = "B. KNN",
      explanation = "KNN had the highest Kappa (0.698), indicating best performance agreement."
    ),
    list(
      text = "What does cross-validation help prevent in model evaluation?",
      options = c("A. Underfitting", "B. Overfitting", "C. Normalisation", "D. Clustering"),
      answer = "B. Overfitting",
      explanation = "Cross-validation estimates generalisation and helps reduce overfitting."
    )
  )
    ...
    tagList(
      ...
      lapply(seq_along(quiz_list_m1), function(i) {
        ...
        div(
          ...
          if (!is.null(q$explanation)) {
            div(style = "margin-top: 10px; font-style: italic; color: #555;", 
                paste("💡 Explanation:", q$explanation))
          }
        )
      })
    )
