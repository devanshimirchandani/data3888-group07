...
samples_to_keep <- intersect(colnames(M_filtered), rownames(pdata42568))

expr_mat <- M_filtered[, samples_to_keep]
pdata42568 <- pdata42568[samples_to_keep, ]

expr_for_pca <- t(expr_mat)

grade_vec <- pdata42568$grade
...
grade_vec <- pdata42568$grade
names(grade_vec) <- rownames(pdata42568)
