...
samples_to_keep <- intersect(colnames(M_filtered), rownames(pdata61304))

expr_mat <- M_filtered[, samples_to_keep]
pdata61304 <- pdata61304[samples_to_keep, ]

expr_for_pca <- t(expr_mat)

grade_vec <- pdata61304$grade
...
grade_vec <- pdata61304$grade
names(grade_vec) <- rownames(pdata61304)
