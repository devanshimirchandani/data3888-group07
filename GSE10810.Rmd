...
samples_to_keep <- intersect(colnames(M_filtered), rownames(pdata10810))

expr_mat <- M_filtered[, samples_to_keep]
pdata10810 <- pdata10810[samples_to_keep, ]

expr_for_pca <- t(expr_mat)

grade_vec <- pdata10810$grade
...
grade_vec <- pdata10810$grade
names(grade_vec) <- rownames(pdata10810)
