---
title: ""  # 留空表示不启用默认标题
author: "Devanshi Mirchandani (520123283), Dorothea (), Weihao Cheng (530086446), Tommi Smits (520487200) and Hamish Sultana ()"

format:
  html:
    css: custom.css
    theme: default  # 不要写 null，Quarto 识别不了
    toc: true
    toc-depth: 3
    toc-location: right
    code-fold: true
    number-sections: true
    include-in-header: logo.html  # 这里拼写必须是 include-in-header（注意不是 includes）
---
...
```{r load-boxplot, fig.width=6, fig.height=3.5, fig.cap="Figure 5: Heatmap of the top genes from the combined dataset and their relevance to each cancer grade."}
