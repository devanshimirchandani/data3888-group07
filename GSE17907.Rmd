...
samples_to_keep <- intersect(colnames(M_filtered), rownames(pdata17907))

expr_mat <- M_filtered[, samples_to_keep]
pdata17907 <- pdata17907[samples_to_keep, ]

expr_for_pca <- t(expr_mat)

grade_vec <- pdata17907$grade
...
grade_vec <- pdata17907$grade
names(grade_vec) <- rownames(pdata17907)
